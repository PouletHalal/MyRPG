...
static void init_comp_hitbox(entity_t *entity, sfVector2f position)
{
    sfFloatRect rect;
...
static void init_comp_input(entity_t *entity, world_t *world)
{
...
static void init_comp_position(entity_t *entity, sfVector2f position)
{
