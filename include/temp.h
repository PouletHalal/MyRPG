...
static const sprite_info_t mob_list[] = {
    {{0, 0, 40, 32}, 10, {40, 32}, {1., 1.}, 5, {2., 2.}},
    {{0, 0, 192, 192}, 12, {192, 192}, {1., 1.}, 5, {2., 2.}},
    {{0, 0, 32, 32}, 16, {32, 32}, {1., 1.}, 5, {2., 2.}},
    {{0, 0, 48, 64}, 16, {48, 64}, {1., 1.}, 5, {2., 2.}},
    {{0, 0, 56, 32}, 6, {56, 32}, {1., 1.}, 5, {2., 2.}},
    {{0, 0, 64, 32}, 6, {64, 32}, {1., 1.}, 5, {2., 2.}},
    {{0, 0, 48, 48}, 18, {48, 48}, {1., 1.}, 5, {2., 2.}},
    {{0, 0, 16, 16}, 16, {16, 16}, {1., 1.}, 5, {2., 2.}},
    {{0, 0, 48, 48}, 16, {48, 48}, {1., 1.}, 5, {2., 2.}},
    {{0, 0, 32, 32}, 8, {32, 32}, {1., 1.}, 5, {2., 2.}},
    {{0, 0, 48, 48}, 6, {48, 48}, {1., 1.}, 5, {2., 2.}},
    {{0, 0, 48, 48}, 6, {48, 48}, {1., 1.}, 5, {2., 2.}},
    {{0, 0, 48, 48}, 6, {48, 48}, {1., 1.}, 5, {2., 2.}},
    {{0, 0, 64, 32}, 6, {64, 32}, {1., 1.}, 5, {2., 2.}},
    {{0, 0, 64, 32}, 6, {64, 32}, {1., 1.}, 5, {2., 2.}},
